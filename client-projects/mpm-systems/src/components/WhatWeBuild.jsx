...
const TAG_COLORS = {
  Core:    { bg: 'rgba(201,168,76,0.1)',  color: 'var(--gold)' },
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 80 }}>
          <div className="reveal">
            ...
            <p style={{ fontSize: 16, color: 'rgba(232,228,221,0.55)', maxWidth: 520, lineHeight: 1.75 }}>
          ...
          {SERVICES.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <p style={{ fontSize: 14, color: 'rgba(232,228,221,0.55)', lineHeight: 1.72 }}>{s.desc}</p>

                {/* Corner mark */}
                <div style={{ position: 'absolute', bottom: 14, right: 14, fontFamily: 'var(--font-display)', fontSize: 9, color: 'rgba(201,168,76,0.18)', letterSpacing: '0.2em' }}>
                  0{i + 1}
                </div>
              </div>
            )
